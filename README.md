...
**Конвейер передачи данных (Data Pipelines)** - это сервис, который принимает данные в качестве входных данных и выводит дополнительные данные. Например, считывает CSV-файл, каким-либо образом преобразует данные и сохраняет их в виде таблицы в базе данных PostgreSQL
